...
//        }
        //$attentionL_status=Db::name('user')->where('id',$user_id)->value('attentionL_status');
        $attention_users=array();
       // if($id==$user_id||$attentionL_status==1) {
...
//            return apiError('user_id不能为空');
//        }
//        $fansL_status = Db::name('user')->where('id', $user_id)->value('fansL_status');
        $fans_users = array();
//        if ($id == $user_id || $fansL_status == 1) {
            $list = Db::name('user_relation')
