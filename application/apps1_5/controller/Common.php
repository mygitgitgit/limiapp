...
return $res;
    ...
    public function videoList($page,$data=[]){
            $res=Db::name('video v')
                ...
                ->join('college col','col.coid=u.college_id','LEFT')
                ->field('v.id,v.user_id,v.title,v.video,v.video_cover,v.height,v.width,v.create_time v_create_time,u.nickname user_nickname,u.head_pic user_head_pic,col.name college,col.coid coid,v.music_id,v.click_num,v.discuss_num,v.music_type')
